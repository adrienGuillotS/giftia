...
{
    public static class CorelMessageBox
    {
        ...
        public static DialogResult MsgShow(this Application corelApp, string message)
        {
            return corelApp.MsgShow(message);
        }
        ...
        /// <returns>  A MessageBoxResult value that specifies which message box button
        ///     is clicked by the user.</returns>
        public static DialogResult MsgShow(this Application corelApp, string message, string caption)
        {
            return corelApp.MsgShow(message, caption);
        }
        ...
        /// <returns>A MessageBoxResult value that specifies which message box button
        ///    is clicked by the user.</returns>
        public static DialogResult MsgShow(this Application corelApp, string message, string caption, DialogButtons buttons)
        {
